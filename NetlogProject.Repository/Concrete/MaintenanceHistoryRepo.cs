...
{
    public class MaintenanceHistoryRepo : efRepositoryBase<MaintenanceHistory>, IMaintenanceHistoryRepo
    {
        public MaintenanceHistoryRepo(DbContext context) : base(context)
        {
